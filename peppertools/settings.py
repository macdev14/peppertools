...
ALLOWED_HOSTS = ['peppertools.herokuapp.com', 'peppertools.lauromtp.com', 'localhost', '0.0.0.0', '127.0.0.1']
...
PROJECT_ROOT   =   AWS_URL#Path(__file__).resolve(strict=True).parent.parent
