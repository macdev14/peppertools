...
class Ferramenta(models.Model):
    ...
    diametro_nucleo = models.FloatField(_("Diâmetro do Núcleo"), null=True, blank=True, db_column="diametro_nucleo")
    diametro_externo = models.FloatField(_("Diâmetro Externo "), null=True, blank=True, db_column="diametro_externo")
    truncamento_raiz_minimo = models.FloatField(_("Truncamento da Raíz (mínimo)"), null=True, blank=True, db_column="truncamento_raiz_minimo")
    truncamento_raiz_maximo = models.FloatField(_("Truncamento da Raíz (máximo)"), null=True, blank=True, db_column="truncamento_raiz_maximo")
    truncamento_crista_minimo = models.FloatField(_("Truncamento da Crista (mínimo)"), null=True, blank=True, db_column="truncamento_crista_minimo")
    truncamento_crista_maximo = models.FloatField(_("Truncamento da Crista (máximo)"), null=True, blank=True, db_column="truncamento_crista_maximo")
    qtd = models.IntegerField(_("Quantidade") ,null=True, blank=True, default=1, db_column="quantidade")
    ...
    def variacaoTruncamentoRaiz(self):
        return self.truncamento_raiz_maximo - self.truncamento_raiz_minimo
    
    def variacaoTruncamentoCrista(self):
        return self.truncamento_crista_maximo - self.truncamento_crista_minimo
...
class Item(models.Model):
    ...
    passo = models.FloatField(_("Passo da Rosca(mm)"), null=True, blank=True, default=1, db_column="passo")
    rosca = models.ForeignKey(Rosca, on_delete=models.SET_NULL, db_column='tipo', related_name="item_rosca", null=True)
    diametro_nucleo = models.FloatField(_("Diâmetro do Núcleo"), null=True, blank=True, db_column="diametro_nucleo")
    diametro_externo = models.FloatField(_("Diâmetro Externo "), null=True, blank=True, db_column="diametro_externo")
    truncamento_raiz_minimo = models.FloatField(_("Truncamento da Raíz (mínimo)"), null=True, blank=True, db_column="truncamento_raiz_minimo")
    truncamento_raiz_maximo = models.FloatField(_("Truncamento da Raíz (máximo)"), null=True, blank=True, db_column="truncamento_raiz_maximo")
    ...
    truncamento_crista_maximo = models.FloatField(_("Truncamento da Crista (máximo)"), null=True, blank=True, db_column="truncamento_crista_maximo")
    tolerancia = models.CharField(_("Tolerância"),db_column="tolerancia", max_length=254, default='')
    norma = models.ForeignKey(Formato, on_delete=models.SET_NULL, null=True,db_column='formato', related_name="format_item")
    ...
    arquivo_desenho = models.FileField(_("Arquivo do desenho"),null=True, blank=True, upload_to=get_image_upload_path, db_column="arquivo_desenho" )
    history = HistoricalRecords()
    ...
    def save(self, *args, **kwargs):
        fer = Ferramenta.objects.create(
            nome=self.nome, 
            arquivo_desenho=self.arquivo_desenho, 
            qtd=self.qtd,
            norma=self.norma,
            passo=self.passo,
            preco=self.preco,
            diametro_nucleo=self.diametro_nucleo, 
            diametro_externo=self.diametro_externo, 
            rosca=self.rosca, 
            tolerancia=self.tolerancia,
            truncamento_raiz_minimo=self.truncamento_raiz_minimo, 
            truncamento_raiz_maximo=self.truncamento_raiz_maximo, 
            truncamento_crista_minimo=self.truncamento_crista_minimo, 
            truncamento_crista_maximo=self.truncamento_crista_maximo, 
            
        )
        super().save(*args, **kwargs)
        for content in self.material.all():
            fer.material.add(content)
        for content in self.processos.all():
            fer.processos.add(content)
